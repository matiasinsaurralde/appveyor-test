...
{
    fprintf(stdout, "GetDirectory is called\n");
...
{
    fprintf(stdout, "GetClrFilesAbsolutePath is called\n");
...
{
    fprintf(stdout, "AddFilesFromDirectoryToTpaList is called\n");
}
...
{
    fprintf(stdout, "ExecuteManagedAssembly is called\n");
    // Indicates failure
    int exitCode = -1;
